...
SECRET_KEY = 'django-insecure-^z4)9vc@513$x(-u9%w%e5%w&lfbmycx1t4!vy4hkfcfu72e6('
...
MONGO_URI = os.getenv("mongodb+srv://storeadmin:@cluster0.obgxlt8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DATABASES = {
    'default': {
        ...
        'CLIENT':{
            'host': 'mongodb+srv://storeadmin:admin12345@cluster0.obgxlt8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0',
        }
    }
}
